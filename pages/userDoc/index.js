...
export default function UserDocStartingPage() {
    ...
    <div>
        <div>
            ...
            <p>Driven by this motivation, PM4KNIME is started by the group <a href="https://www.pads.rwth-aachen.de/cms/~pnbx/PADS/" rel="nofollow">Process And Data Science</a> at the university RWTH Aachen. Developed as a community extension for KNIME, PM4KNIME integrates ProM into KNIME by wrapping ProM plugins as operational nodes in KNIME. Those nodes can connect each other and build a workflow to complete process mining tasks.</p>
            <p>By bring process mining techniques into KNIME, PM4KNIME benefits the users from the following perspectives:</p>
            <ul>
                <li>Large-scale and repetitive experiments. Process mining experiments in the analytical workflow context can be executed with just one click.</li>
                <li>Reuse and Share of process mining analysis. With predefined configuration and input, those workflows reproduce the same result. Moreover, KNIME eases the share of process mining analysis by sharing the workflows.</li>
                <li>Ability to use process mining techniques in KNIME. With PM4KNIME, KNIME users avoid the transfer of different platforms.</li>
                <li>Ability to use KNIME data analytic extensions. KNIME provides nodes to support the preprocess and post-process of data for the process mining algorithm.</li>
            </ul>
            <h1>Documentation Sections</h1>
            <ul>
                <li>
                    <p>Normal User: This section provides the manual for normal users with KNIME. It is divided into the following parts.</p>
                    <ul>
                ...
                <li>
                    <p>Developer: This part aims to guide developers to understand PM4KNIME better and reducing effort and pain during programming. It includes the following parts.</p>
                    <ul>
