      ...
      <div className="container">
        <div className="section">
          <p>
            ...
            examples. The data set for those examples is located in github under
            the{" "}
          ...
          <p>
            Based on the dataset, multiple workflows are built to show the usage
          ...
          <p>
            This part incldues the repeative workflow execution in KNIME. How to
            Loop and FlowVaribale is the practice focus.
          </p>
          <h5>&nbsp;</h5>
          <h5>
          ...
          <p>
            This part explores the potential use of other functions from KNIME,
            in order to achieve more computation power of PM4KNIME.
          </p>
          <h5>&nbsp;</h5>
          <h5>
