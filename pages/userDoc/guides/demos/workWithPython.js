                                ...
                                <div class="markdown-body">
                                  ...
                                  >
                                    ...
                                    >
                                      <div class="markdown-body">
                                        <p>
                                          Python extension in KNIME enables the
                                          python scripting. By importing python
                                          environment with different packages,
                                          it allows the python execution in such
                                          environments. In a personal view, the
                                          configuration is the most complex part
                                          to import the Python scripting. After
                                          this, in the Python extension nodes,
                                          python scripts are like the normal
                                          ones. In this demo, we shows two parts
                                          of the Python usages. One is the basic
                                          Python scripting, the other focuses on
                                          the integration of pm4py into KNIME.
                                        </p>
                                        <p>
                                          First, to configure Python in KNIME by
                                          following this steps in the{" "}
                                          <a
                                          ...
                                          . In brief summary, those steps are in
                                          need.
                                        </p>
                                        <ol>
                                          <li>
                                            Download and install Python with
                                            miniconda or Annaconda. Minicanda is
                                            chosen to benefit the integration of
                                            pm4py. The installation steps are
                                            the same as pm4py in this{" "}
                                            <a
                                          ...
                                          <li>
                                            <a
                                              ...
                                              rel="nofollow"
                                            >
                                              Install the Python Extension in
                                              KNIME
                                            </a>
                                          </li>
                                        </ol>
                                        <blockquote>
                                          <p>
                                            File=&gt; Install KNIME Extension
                                            =&gt; Search Python Extension =&gt;
                                            Install
                                          </p>
                                        </blockquote>
                                        <ol start="3">
                                        ...
                                        <blockquote>
                                          <p>
                                            File=&gt;Perference =&gt; Search
                                            Python =&gt; Use the created env for
                                            pm4py.
                                          </p>
                                        </blockquote>
                                        <h3>&nbsp;</h3>
                                        <h3>
                                          the normal python scripting in KNIME,
                                          similarly like Java Snippet.
                                        </h3>
                                        <p>
                                          <img
                                          ...
                                          />{" "}
                                          <br></br>A concrete workflow is shown
                                          in the next figure. <br></br>
                                          <img
                                        ...
                                        <p>
                                          To create this workflow, those steps
                                          are in need:
                                        </p>
                                        <ol>
                                          <li>
                                            Download the dataset{" "}
                                            <code>chapter_1</code> from the
                                            github{" "}
                                          ...
                                          <li>
                                            Import CSV into KNIME with node{" "}
                                            <strong>CSV Reader</strong>.
                                          </li>
                                          <li>
                                            Use node{" "}
                                            <strong>Python Script</strong> to
                                            add a category to the Data table.
                                          </li>
                                        </ol>
                                        <ul>
                                          <li>
                                            Configure the node{" "}
                                            <strong>Python Script</strong> with
                                            settings
                                          </li>
                                        </ul>
                                        <div class="highlight highlight-source-python position-relative overflow-auto">
                                          <pre>
                                            ...
                                            <span class="pl-en">len</span>(
                                            <span class="pl-s1">
                                              costValues
                                            </span>
                                            ))
                                            <span class="pl-en">print</span>(
                                            <span class="pl-s">"begin"</span>)
                                            <span class="pl-s1">ctg</span>{" "}
                                            <span class="pl-c1">=</span>{" "}
                                            <span class="pl-en">list</span>()
                                            <span class="pl-k">for</span>{" "}
                                            <span class="pl-s1">idx</span>{" "}
                                            <span class="pl-c1">in</span>{" "}
                                            <span class="pl-en">range</span>(
                                            ...
                                            <span class="pl-s1">ctg</span>.
                                            <span class="pl-en">append</span>(
                                            <span class="pl-s">"medium"</span>)
                                            <span class="pl-k">else</span>:
                                            <span class="pl-s1">ctg</span>.
                                            <span class="pl-en">append</span>(
                                            <span class="pl-s">"low"</span>)
                                            <span class="pl-en">print</span>(
                                            <span class="pl-en">len</span>(
                                            <span class="pl-s1">ctg</span>))
                                            <span class="pl-s1">
                                        ...
                                        <p>
                                          After execution, it outputs the result{" "}
                                          <br></br>
                                          <img
                                        ...
                                        <p>
                                          The task is to use the pm4py for
                                          process discovery. <br></br>{" "}
                                          <img
                                            ...
                                            className="img-fluid img-shadow"
                                          />
                                          <br></br> To simplify the workflow,
                                          the input and output are enclosed in
                                          Python Script. In this way, the
                                        ...
                                        <ol>
                                          <li>
                                            Drag node{" "}
                                            <strong>Python Source</strong> into
                                            KNIME
                                          </li>
                                          <li>
                                        ...
                                        <div class="highlight highlight-source-python position-relative overflow-auto">
                                          <pre>
                                            ...
                                            <span class="pl-s1">pandas</span>{" "}
                                            <span class="pl-k">import</span>{" "}
                                            <span class="pl-v">DataFrame</span>
                                            <span class="pl-k">from</span>{" "}
                                            <span class="pl-s1">pm4py</span>.
                                            <span class="pl-s1">algo</span>.
                                            <span class="pl-s1">discovery</span>
                                            .<span class="pl-s1">alpha</span>{" "}
                                            <span class="pl-k">import</span>{" "}
                                            <span class="pl-s1">factory</span>{" "}
                                            ...
                                            <span class="pl-k">from</span>{" "}
                                            <span class="pl-s1">pm4py</span>.
                                            <span class="pl-s1">objects</span>.
                                            <span class="pl-s1">log</span>.
                                            <span class="pl-s1">importer</span>.
                                            <span class="pl-s1">xes</span>{" "}
                                            <span class="pl-k">import</span>{" "}
                                            <span class="pl-s1">factory</span>{" "}
                                            <span class="pl-k">as</span>{" "}
                                            <span class="pl-s1">
                                        ...
                                        <ol start="3">
                                          <li>
                                            Execute the workflow, output the
                                            view of generated process model.{" "}
                                            <img
                                        ...
                                        <p>
                                          Here only the simply ussage case is
                                          shown to integrate pm4py into KNIME.
                                          Anyway, it is an interesting task and
                                          needs more exploration later.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
