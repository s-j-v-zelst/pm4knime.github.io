        ...
        <div className="section">
          <div className="row-userDoc">
            ...
            <ul>
              ...
              <li>
                <strong>local flow variable</strong> with explicit port to
                connect to node, it has effect on the{" "}
                <strong>all nodes after the port connection</strong>. We can
                also transfer data value into flow variable by using node{" "}
                <em>
                  <strong>Table Row to Variable</strong>
                </em>{" "}
                is used to define new flow variables. The names of flow
                variables are defined by the column names.
              </li>
            </ul>
            <h2>&nbsp;</h2>
            ...
            <ul>
              ...
              <li>
                After execution Loop, the result from each iteration is
                summarized at the <code>XXX Loop End</code>.
              </li>
              <li>
