      ...
      <div className="container">
        <div className="section">
          ...
          <p>
            ...
            classical ProM plugins into KNIME platform and brings process mining
            into the analytical workflow environment. In this way, it eases the
            users to conduct large-scale and repetitive experiments, reuse and
            share the process mining analysis by predefined configuration, and
            process data with existing operations in KNIME.
          </p>
          <p>
            With respect to the PM4KNIME nodes functionality, we categorize the
            PM4KIME features in the following part:
          </p>
          <h3>&nbsp;</h3>
          <h3>Category</h3>
          <p>
          ...
          <table className="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  read an event log in .xes,.mxml format with strategy of Open
                  Naive or Lenient
                </td>
                <td>file path</td>
              ...
              <tr>
                ...
                <td>
                  read/write an Petri net in format .pnml from/to an local disk
                </td>
                <td>file path</td>
          ...
          <table className="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  convert a data table, the default data type of KNIME, into the
                  event log that is processed by ProM
                </td>
                <td>data table</td>
          ...
          <table className="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  there are two types of filter: one works on the trace variant.
                  if the trace variant is over the frequency threshold, all the
                  traces in this variant meets the filter condition; one work on
                  the whole event log by cumulative frequency. All trace
                  variants are sorted w.r.t. frequency in descending order.
                  Trace variants are accumulated until their sum meets the
                  filter criteria.
                </td>
                <td>event log</td>
                <td>event log</td>
          ...
          <ul>
            <li>
              conformance checking Conformance checking analyzes the deviations
              between a reference process model and observed behaviors driven
              from its execution. Firstly, alignment-based replay is carried
              with inputs of an event log and Petri net. The replayed result is
              given in alignment. Based on the alignment, it evaluates the model
              in the listed perspectives.
            </li>
          </ul>
          <table className="table table-striped">
            <thead>
            ...
            <tbody>
              ...
              <tr>
                <td>Performance</td>
                <td>
                  based on the alignment, calculate the performance according to
                  time metrics, like throughput time, waiting time
                </td>
                <td>replayer result in alignment</td>
              ...
              <tr>
                <td>Precision</td>
                <td>
                  based on the alignment, check precision that measures how much
                  the model allows more behavior than event log
                </td>
                <td>replayer result in alignment</td>
