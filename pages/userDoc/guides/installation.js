      ...
      <div className="container">
        <div className="section">
          ...
          <p>
            ...
            separately by giving a link. KNIME Server supports workflow sharing
            and cooperation in KNIME, its use and installation are optional in
            this project.
          </p>
          <h4>&nbsp;</h4>
          <h4>ATTENTION!!</h4>
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  : asks for the registration on KNIME to support future updates
                  and help. You can skip it and go directly to
                </li>
                <li>
                  <a
                ...
                <li>
                  ...
                  : some guides on the basic usage on KNIME. After reading this
                  instruction, you should be able to create a workflow in KNIME,
                  and read CSV file into KNIME.
                </li>
              </ul>
            </li>
          </ul>
          ...
          <p>
            If this website is not listed in "Available Software Sites", you can
            add the community experimental website by clicking on Add in the
            right panel and choosing
          </p>
          <ul>
            <li>
          ...
          <p>
            After installation of PM4KNIME, if there is a new version available,
            it is recommended to update the installed version. The update can be
            done into ways:
          </p>
          <ul>
          ...
          <ol>
            <li>
              <strong>File</strong> &gt; <strong>Update KNIME</strong>. It lists
              all the extensions for updates. Sometimes, it takes a long time to
              show.
            </li>
          ...
          <ol>
            ...
            <li>
              <p>
                Choose pm4knime Feature. At the bottom, three options are shown,{" "}
                <strong>Update</strong>, <strong>Uninstall</strong> and{" "}
            ...
            <li>
              <p>
                Click on <strong>Uninstall</strong> and follow the instructions
                later to uninstall PM4KNIME.
              </p>
            </li>
          </ol>
          <h3>&nbsp;</h3>
          ...
          <ul>
            ...
            <li>
              the active state of one user is marked since he/she logs in KNIME
              Server. It will turn into idle after one week.
            </li>
            <li>
            ...
            <li>
              the license is valid for one year. Before they expire, We need to
              contact KNIME team again to update the license.
            </li>
          </ul>
        </div>
      </div>
